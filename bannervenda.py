...
class BannerVenda(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        esquerda_image = Image(size_hint=(1, 0.75), pos_hint={"right": 1, "top": 0.90}, source=f"icones/fotos_clientes/{foto_cliente}")
        esquerda_label = Label(text=cliente, pos_hint={"right": 1, "top": 0.15}, size_hint=(1, 0.15))
        esquerda.add_widget(esquerda_image)
        esquerda.add_widget(esquerda_label)

        meio = FloatLayout()
        meio_image = Image(size_hint=(1, 0.75), pos_hint={"right": 1, "top": 0.90}, source=f"icones/fotos_produtos/{foto_produto}")
        meio_label = Label(text=produto, pos_hint={"right": 1, "top": 0.15}, size_hint=(1, 0.15))
